...
import { AiConsultingSection } from "@/components/portfolio/AiConsultingSection";
  ...
  return (
    <div className="site">
      ...
      <div className="site-shell">
        ...
        {data.consultingDecks && data.consultingDecks.length > 0 ? (
          <AiConsultingSection items={data.consultingDecks} />
        ) : null}
